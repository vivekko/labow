...
void solve(){
    ...
    char fac = 'E';
    for(int i=0;i<779;i++){
        if(a[i][0] == 'F') mp[fac]+=stoi(a[i].substr(1));
        if(a[i][0] == 'N') mp['N']+=stoi(a[i].substr(1));
        if(a[i][0] == 'W') mp['W']+=stoi(a[i].substr(1));
        if(a[i][0] == 'E') mp['E']+=stoi(a[i].substr(1));
        if(a[i][0] == 'S') mp['S']+=stoi(a[i].substr(1));
        if(a[i][0] == 'L'){ 
        if(stoi(a[i].substr(1)) == 90 )     {if(fac == 'N')  fac = 'W'; else if(fac == 'E')  fac = 'N'; else if(fac == 'W')  fac = 'S'; else if(fac == 'S')  fac = 'E';continue;}
        else if(stoi(a[i].substr(1)) == 180){if(fac == 'N')  fac = 'S'; else if(fac == 'E')  fac = 'W'; else if(fac == 'W')  fac = 'E'; else if(fac == 'S')  fac = 'N';continue;}
        else if(stoi(a[i].substr(1)) == 270){if(fac == 'N')  fac = 'E'; else if(fac == 'E')  fac = 'S'; else if(fac == 'W')  fac = 'N'; else if(fac == 'S')  fac = 'W';continue;}
        }
        if(a[i][0] == 'R'){ 
